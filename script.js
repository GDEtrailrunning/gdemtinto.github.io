...
const dataLine1 = {
  ...
  datasets: [{
    ...
    data: [12, 14, 10, 18], // Datos de los km recorridos en cada día
...
const dataLine2 = {
  labels: ['Día 1', 'Día 2', 'Día 3', 'Día 4'], // Etiquetas de los días
  datasets: [{
    label: 'Km recorridos en Semana 48',
    data: [9, 13, 13, 0], // Datos de los km recorridos en cada día
...
function actualizarDiasRestantes() {
  // Fecha objetivo fija
  const objetivoDate = new Date('2025-11-02');
