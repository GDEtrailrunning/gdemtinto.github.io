...
const dataLine1 = {
  ...
  datasets: [{
    ...
    data: [16, 12, 15, 22], // Datos de los km recorridos en cada día
...
const dataLine2 = {
  labels: ['Día 1', 'Día 2', 'Dia 3', 'Dia 4'], // Etiquetas de los días
  datasets: [{
    label: 'Km recorridos en Semana 28',
    data: [15, 18, 11, 16], // Datos de los km recorridos en cada día
