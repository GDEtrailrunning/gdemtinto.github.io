...
const dataLine1 = {
  ...
  datasets: [{
    ...
    data: [10, 17, 12, 16], // Datos de los km recorridos en cada día
...
const dataLine2 = {
  labels: ['Día 1', 'Día 2', 'Dia 3'], // Etiquetas de los días
  datasets: [{
    label: 'Km recorridos en Semana 26',
    data: [7, 10, 38], // Datos de los km recorridos en cada día
